 ...
 * ============================================================================
 *
 * DataTable list for improvements with column search.
 *
...
const ImprovementMainPage = {
    ...
    init: function () {
        var table = $('#improvements-table').DataTable({
            ...
            { extend: 'colvis', text: '<i class="fas fa-columns"></i> Kolom', className: 'btn-sm sap-btn sap-btn-secondary' },
        ],
        ...
        DtToolbar.relocate(table, '#improvements-toolbar');
        ...
        $('#improvements-table tbody').on('click', 'tr', function () {
            ...
            if (rowData && rowData.id) {
                window.location.href = site_url + '/improvements/' + rowData.id;
            }
        });
    }
};
...
window.ImprovementMainPage = ImprovementMainPage;

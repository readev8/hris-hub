...
/**
 * ============================================================================
 * BLUEPRINTS - MAIN LISTING
 * ============================================================================
 *
 * Description: Lists all development blueprints with search/filter capabilities
 *
 * Required: none
 * Optional: none
...
<div class="dt-toolbar" id="blueprints-toolbar" role="toolbar" aria-label="Alat ekspor"></div>
...
<link rel="stylesheet" href="<?= asset_url('public/assets/css/page/blueprints/main_page.css') ?>">
<?= $this->endSection() ?>
...
<script defer src="<?= asset_url('public/assets/js/page/blueprints/main_page.js') ?>"></script>
<?= $this->endSection() ?>

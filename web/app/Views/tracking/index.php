...
<head>
    ...
    <link rel="stylesheet" href="<?= asset_url('public/assets/css/page/tracking/index.css') ?>">
</head>
<body>
    ...
    <script defer src="<?= asset_url('public/vendor/jquery/3.7.1/jquery.min.js') ?>"></script>
    <script>

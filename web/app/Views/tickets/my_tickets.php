...
<div class="dt-toolbar" id="my-tickets-toolbar" role="toolbar" aria-label="Alat ekspor"></div>
...
<link rel="stylesheet" href="<?= asset_url('public/assets/css/page/tickets/my_tickets.css') ?>">
<?= $this->endSection() ?>
...
<script defer src="<?= asset_url('public/assets/js/page/tickets/my_tickets.js') ?>"></script>
<?= $this->endSection() ?>

...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-secondary mb-0" style="font-size:13px">Manage bug reports, issues, and tasks</p>
    </div>
    ...
    $('#tickets-table').DataTable({
        ...
        columns: [
            ...
            },
            {
                ...
                orderable: false,
                render: function(d) {
                    return '<a href="' + site_url + '/tickets/' + d + '" class="sap-btn sap-btn-secondary sap-btn-sm"><i class="fas fa-eye"></i></a>';
                }
            }
        ],
        order: [[7, 'desc']],

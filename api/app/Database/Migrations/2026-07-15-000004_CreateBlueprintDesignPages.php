...
class CreateBlueprintDesignPages extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->createTable(Tables::BLUEPRINT_DESIGN_PAGES);
    }

    public function down()
    {
        $this->forge->dropTable(Tables::BLUEPRINT_DESIGN_PAGES);
    }
}

...
--
-- Table structure for table `hrhub_users`
--

DROP TABLE IF EXISTS `hrhub_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2026-08-18 16:14:51

...
-- Converted for compatibility with MariaDB 10.1.48
--
-- Host: localhost    Database: hr_selfservice
-- ------------------------------------------------------
...
--
-- Table structure for table `hrhub_access_modules`
--

DROP TABLE IF EXISTS `hrhub_access_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_access_modules` (
...
--
-- Dumping data for table `hrhub_access_modules`
--

LOCK TABLES `hrhub_access_modules` WRITE;
/*!40000 ALTER TABLE `hrhub_access_modules` DISABLE KEYS */;
INSERT INTO `hrhub_access_modules` VALUES (1,'Dashboard','dashboard','fas fa-th-large',1,0),(2,'Tickets','tickets','fas fa-ticket',2,0),(3,'Improvements','improvements','fas fa-rocket',3,0),(4,'Need Approvals','approvals','fas fa-check-circle',4,0),(5,'Master Projects','master_projects','fas fa-folder-tree',5,0),(6,'Users','users','fas fa-users',6,0),(7,'Roles','roles','fas fa-user-shield',7,0),(8,'Blueprints','blueprints','fas fa-drafting-compass',8,0),(9,'Module Flows','module_flows','fas fa-diagram-project',9,0);
/*!40000 ALTER TABLE `hrhub_access_modules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_api_keys`
--

DROP TABLE IF EXISTS `hrhub_api_keys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_api_keys` (
  ...
  `active` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_key` (`api_key`(191))
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_api_keys`
--

LOCK TABLES `hrhub_api_keys` WRITE;
/*!40000 ALTER TABLE `hrhub_api_keys` DISABLE KEYS */;
INSERT INTO `hrhub_api_keys` VALUES (1,'0a99ba4084fbfd7c59188477d177f8daaf45b742a8dfadf47aecb114aace8341','Web App Service Key',1,'2026-07-01 13:56:00',0);
/*!40000 ALTER TABLE `hrhub_api_keys` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_approval_requests`
--

DROP TABLE IF EXISTS `hrhub_approval_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_approval_requests` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `approval_requests_approver_id_foreign` FOREIGN KEY (`approver_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `approval_requests_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `hrhub_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `approval_requests_requester_id_foreign` FOREIGN KEY (`requester_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_approval_requests`
--

LOCK TABLES `hrhub_approval_requests` WRITE;
/*!40000 ALTER TABLE `hrhub_approval_requests` DISABLE KEYS */;
INSERT INTO `hrhub_approval_requests` VALUES (9,9,NULL,6,6,1,1,NULL,'2026-07-14 10:13:50','2026-07-14 10:13:50',0),(10,9,NULL,6,6,2,1,NULL,'2026-07-14 10:14:00','2026-07-14 10:14:00',0);
/*!40000 ALTER TABLE `hrhub_approval_requests` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_audit_logs`
--

DROP TABLE IF EXISTS `hrhub_audit_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_audit_logs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `hrhub_blueprint_approval_requests` (
  ...
  CONSTRAINT `blueprint_approval_requests_approver_id_foreign` FOREIGN KEY (`approver_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `blueprint_approval_requests_blueprint_id_foreign` FOREIGN KEY (`blueprint_id`) REFERENCES `hrhub_blueprints` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blueprint_approval_requests_requester_id_foreign` FOREIGN KEY (`requester_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_blueprint_approval_requests`
--

LOCK TABLES `hrhub_blueprint_approval_requests` WRITE;
/*!40000 ALTER TABLE `hrhub_blueprint_approval_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `hrhub_blueprint_approval_requests` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_blueprint_attachments`
--

DROP TABLE IF EXISTS `hrhub_blueprint_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_blueprint_attachments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `blueprint_id` bigint unsigned NOT NULL,
  ...
  CONSTRAINT `blueprint_attachments_blueprint_id_foreign` FOREIGN KEY (`blueprint_id`) REFERENCES `hrhub_blueprints` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blueprint_attachments_module_id_foreign` FOREIGN KEY (`module_id`) REFERENCES `hrhub_blueprint_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blueprint_attachments_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_blueprint_attachments`
--

LOCK TABLES `hrhub_blueprint_attachments` WRITE;
/*!40000 ALTER TABLE `hrhub_blueprint_attachments` DISABLE KEYS */;
INSERT INTO `hrhub_blueprint_attachments` VALUES (1,2,NULL,'business_scenario',4,6,'1-4.webp','1784149218_f6b1d078f7d58f3d.webp','image/webp',73666,'2026-07-15 14:00:18',0),(3,2,NULL,'business_scenario',4,6,'1-6.png','1784149572_12a327a92cf8243d.png','image/png',85384,'2026-07-15 14:06:12',0),(4,2,1,'design_page',3,6,'1-4.webp','1784149643_4839a3fd2aca1911.webp','image/webp',73666,'2026-07-15 14:07:23',0),(6,2,NULL,'design_page',3,6,'1-6.webp','1784149651_e68f87fdb9ea82b3.webp','image/webp',35144,'2026-07-15 14:07:31',0),(7,3,4,'business_scenario',6,6,'Screenshot 2026-07-16 at 16.52.24.png','1784195619_0396472aff5cdcfc.png','image/png',251940,'2026-07-16 02:53:39',0),(8,3,4,'business_scenario',7,6,'Screenshot 2026-07-16 at 16.54.15.png','1784195684_b1d4a8935f1d4b31.png','image/png',366013,'2026-07-16 02:54:44',0),(9,3,4,'business_scenario',8,6,'Screenshot 2026-07-16 at 16.59.24.png','1784195994_84bd824da28afb49.png','image/png',136299,'2026-07-16 02:59:54',0),(10,3,4,'business_scenario',9,6,'Screenshot 2026-07-16 at 17.00.17.png','1784196046_2cff985534c58b8d.png','image/png',191981,'2026-07-16 03:00:46',0),(11,3,4,'design_page',4,6,'Screenshot 2026-07-16 at 17.01.29.png','1784196144_eaae9c68ac294c67.png','image/png',313396,'2026-07-16 03:02:24',0),(12,6,10,'design_page',6,6,'pngegg.png','1784534946_fefc4cd71f72818e.png','image/png',35855,'2026-07-20 01:09:06',0),(13,9,NULL,'business_scenario',17,6,'IMG-20260630-WA0016.jpg','1787239744_9f2485b583886de3.jpg','image/jpeg',425043,'2026-08-20 08:29:04',0),(14,9,NULL,'business_scenario',17,6,'IMG-20260630-WA0012.jpg','1787239903_f66a4316412bf028.jpg','image/jpeg',122269,'2026-08-20 08:31:43',0);
/*!40000 ALTER TABLE `hrhub_blueprint_attachments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_blueprint_business_scenarios`
--

DROP TABLE IF EXISTS `hrhub_blueprint_business_scenarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_blueprint_business_scenarios` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `hrhub_blueprint_comments` (
  ...
  KEY `blueprint_id` (`blueprint_id`),
  CONSTRAINT `blueprint_comments_blueprint_id_foreign` FOREIGN KEY (`blueprint_id`) REFERENCES `hrhub_blueprints` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blueprint_comments_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_blueprint_comments`
--

LOCK TABLES `hrhub_blueprint_comments` WRITE;
/*!40000 ALTER TABLE `hrhub_blueprint_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `hrhub_blueprint_comments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_blueprint_design_pages`
--

DROP TABLE IF EXISTS `hrhub_blueprint_design_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_blueprint_design_pages` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `module_id` bigint unsigned NOT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `hrhub_blueprint_page_specifications` (
  ...
  PRIMARY KEY (`id`),
  KEY `module_id` (`module_id`),
  CONSTRAINT `blueprint_page_specifications_module_id_foreign` FOREIGN KEY (`module_id`) REFERENCES `hrhub_blueprint_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_blueprint_page_specifications`
--

LOCK TABLES `hrhub_blueprint_page_specifications` WRITE;
/*!40000 ALTER TABLE `hrhub_blueprint_page_specifications` DISABLE KEYS */;
INSERT INTO `hrhub_blueprint_page_specifications` VALUES (1,4,4,'nama','','digunakan untuk input nama','','kosong','kosong','Input','text','text','',0,'2026-07-17 03:25:59','2026-07-17 18:22:33',0),(2,9,5,'Upload file','upload','Digunakan untuk memilih file yang akan di upload','kosong','','Sesuai dengan master data','Input','excel','uploadfile',NULL,0,'2026-07-18 02:37:22','2026-07-18 02:37:22',0),(3,11,7,'Jobcode','varchar','jobcode bisa terisi','','','','Input','text','text',NULL,0,'2026-07-22 02:43:10','2026-07-22 02:43:10',0);
/*!40000 ALTER TABLE `hrhub_blueprint_page_specifications` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_blueprints`
--

DROP TABLE IF EXISTS `hrhub_blueprints`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_blueprints` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `blueprints_approver_id_foreign` FOREIGN KEY (`approver_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `blueprints_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `blueprints_improvement_id_foreign` FOREIGN KEY (`improvement_id`) REFERENCES `hrhub_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_blueprints`
--

LOCK TABLES `hrhub_blueprints` WRITE;
/*!40000 ALTER TABLE `hrhub_blueprints` DISABLE KEYS */;
INSERT INTO `hrhub_blueprints` VALUES (1,9,'testing','testing Dan implementasi',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,99,NULL,6,'2026-07-14 15:51:54','2026-07-14 15:51:54',1),(2,10,'testing','asdlasdlaskdjnsakd',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,99,NULL,6,'2026-07-15 03:18:16','2026-07-15 03:18:16',1),(3,NULL,'HRIS OS','Untuk administrasi sistem HRIS',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-16 02:37:08','2026-07-16 02:37:08',0),(4,NULL,'Assignment [PAF]','Sistem penugasan pegawai',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-17 20:58:17','2026-07-17 20:58:17',0),(5,11,'Import Upload file pada Memo Mutasi','Digunakan untuk memudahkan admin OS untuk untut memo mutasi berisi perpindahan regu Dan nomor urut',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-18 02:35:44','2026-07-18 02:35:44',0),(6,NULL,'CI - SS','Aplikasi yang digunakan untuk input Sumbang Saran Pegawai',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-20 01:07:32','2026-07-29 03:02:28',0),(7,NULL,'OCHA (Organization Charts)','Aplikasi untuk create jobdesc, update SO Dan lain-lain',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-22 02:40:57','2026-07-29 03:02:59',0),(8,NULL,'Talent  Review (9box)','Digunakan untuk melakukan talent review pegawai',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-29 03:08:39','2026-07-29 03:08:39',0),(9,NULL,'Succession Planning','Digunakan untuk assign succession plan jabatan',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,6,'2026-07-29 03:26:39','2026-07-29 03:26:39',0);
/*!40000 ALTER TABLE `hrhub_blueprints` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_flow_connections`
--

DROP TABLE IF EXISTS `hrhub_flow_connections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_flow_connections` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `from_module_id_to_module_id` (`from_module_id`,`to_module_id`),
  KEY `hrhub_flow_connections_created_by_foreign` (`created_by`),
  KEY `from_module_id` (`from_module_id`),
  KEY `to_module_id` (`to_module_id`),
  CONSTRAINT `hrhub_flow_connections_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `hrhub_flow_connections_from_module_id_foreign` FOREIGN KEY (`from_module_id`) REFERENCES `hrhub_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `hrhub_flow_connections_to_module_id_foreign` FOREIGN KEY (`to_module_id`) REFERENCES `hrhub_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_flow_connections`
--

LOCK TABLES `hrhub_flow_connections` WRITE;
/*!40000 ALTER TABLE `hrhub_flow_connections` DISABLE KEYS */;
INSERT INTO `hrhub_flow_connections` VALUES (1,7,14,6,'2026-08-18 07:26:36','2026-08-18 18:47:57',1),(2,16,15,6,'2026-08-18 18:00:14','2026-08-19 02:52:38',0),(3,16,13,6,'2026-08-18 18:00:42','2026-08-19 02:52:42',0),(4,7,8,6,'2026-08-18 18:26:13','2026-08-18 18:48:16',1),(5,8,14,6,'2026-08-18 18:26:13','2026-08-18 18:47:57',1),(6,7,16,6,'2026-08-18 19:44:13','2026-08-18 23:10:16',1),(7,7,13,6,'2026-08-18 19:44:13','2026-08-18 23:10:23',1),(8,15,13,6,'2026-08-19 02:42:37','2026-08-19 02:52:05',1),(9,13,15,6,'2026-08-19 02:51:54','2026-08-19 02:52:05',1),(10,16,7,6,'2026-08-19 02:53:52','2026-08-19 03:02:09',1),(11,16,17,6,'2026-08-19 02:54:55','2026-08-20 05:44:42',1),(12,21,20,6,'2026-08-20 05:03:23','2026-08-20 05:03:23',0),(13,20,17,6,'2026-08-20 06:14:03','2026-08-20 06:14:03',0);
/*!40000 ALTER TABLE `hrhub_flow_connections` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_flow_node_positions`
--

DROP TABLE IF EXISTS `hrhub_flow_node_positions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_flow_node_positions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `module_id` bigint unsigned NOT NULL,
  ...
  KEY `hrhub_flow_node_positions_created_by_foreign` (`created_by`),
  CONSTRAINT `hrhub_flow_node_positions_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `hrhub_flow_node_positions_module_id_foreign` FOREIGN KEY (`module_id`) REFERENCES `hrhub_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_flow_node_positions`
--

LOCK TABLES `hrhub_flow_node_positions` WRITE;
/*!40000 ALTER TABLE `hrhub_flow_node_positions` DISABLE KEYS */;
INSERT INTO `hrhub_flow_node_positions` VALUES (1,7,'Post Jobs',658,438,6,'2026-08-18 07:25:27','2026-08-19 03:02:09',1),(2,14,NULL,1072,325,6,'2026-08-18 07:26:05','2026-08-20 16:51:32',0),(4,16,NULL,134,43,6,'2026-08-18 17:59:57','2026-08-20 16:51:27',0),(5,15,NULL,766,89,6,'2026-08-18 18:00:09','2026-08-20 16:51:27',0),(6,13,NULL,451,322,6,'2026-08-18 18:00:32','2026-08-20 16:51:34',0),(7,8,NULL,375,620,6,'2026-08-18 18:25:45','2026-08-20 06:14:44',1),(8,17,NULL,660,472,6,'2026-08-19 02:54:40','2026-08-20 16:51:30',0),(9,9,NULL,727,417,6,'2026-08-19 03:06:03','2026-08-20 06:14:55',1),(10,21,NULL,43,211,6,'2026-08-20 05:03:06','2026-08-20 16:51:28',0),(11,20,NULL,369,523,6,'2026-08-20 05:03:16','2026-08-20 16:51:27',0);
/*!40000 ALTER TABLE `hrhub_flow_node_positions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_master_projects`
--

DROP TABLE IF EXISTS `hrhub_master_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_master_projects` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  CONSTRAINT `master_projects_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_master_projects`
--

LOCK TABLES `hrhub_master_projects` WRITE;
/*!40000 ALTER TABLE `hrhub_master_projects` DISABLE KEYS */;
INSERT INTO `hrhub_master_projects` VALUES (7,'Career Backend','Aplikasi backend aplikasi',1,6,'2026-07-13 01:12:57','2026-07-13 01:12:57',1),(8,'Personnel Administration Form (PAF)','',1,6,'2026-07-15 23:07:55','2026-08-18 03:24:47',0),(9,'Hiring Management','Proses Recruitment',1,6,'2026-07-15 23:08:07','2026-07-16 02:26:34',0),(10,'Development &amp; Learning Management','',1,6,'2026-07-15 23:41:53','2026-07-16 02:25:48',0),(11,'Performance Evaluation','',1,6,'2026-07-16 02:26:52','2026-07-16 02:26:52',0),(12,'Self Service','',1,6,'2026-07-16 02:27:05','2026-07-16 02:27:05',0),(13,'HRIS OS','',1,6,'2026-07-16 02:27:21','2026-07-16 02:27:21',0),(14,'CI-SS','CI-SS',1,6,'2026-07-20 00:56:42','2026-07-20 00:56:42',0),(15,'Ocha (Organization Chart)','',1,6,'2026-07-22 02:37:49','2026-07-22 02:37:49',0),(16,'Insight','',1,6,'2026-08-18 02:46:52','2026-08-18 02:46:52',0),(17,'Kamus Kompetensi','',1,6,'2026-08-20 02:19:37','2026-08-20 02:19:37',0),(18,'HRIS','',1,6,'2026-08-20 06:17:10','2026-08-20 06:17:10',0);
/*!40000 ALTER TABLE `hrhub_master_projects` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_master_user_types`
--

DROP TABLE IF EXISTS `hrhub_master_user_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_master_user_types` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Dumping data for table `hrhub_master_user_types`
--

LOCK TABLES `hrhub_master_user_types` WRITE;
/*!40000 ALTER TABLE `hrhub_master_user_types` DISABLE KEYS */;
INSERT INTO `hrhub_master_user_types` VALUES (1,'Admin Departemen','Administrator departemen yang mengelola sistem',1,'2026-07-28 17:23:24','2026-07-28 17:23:24'),(2,'Kepala Departemen','Kepala departemen yang melakukan approval',1,'2026-07-28 17:23:24','2026-07-28 17:23:24'),(3,'User (Sistem)','Pengguna sistem yang menggunakan aplikasi',1,'2026-07-28 17:23:24','2026-07-28 17:23:24');
/*!40000 ALTER TABLE `hrhub_master_user_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_module_blueprint_modules`
--

DROP TABLE IF EXISTS `hrhub_module_blueprint_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_module_blueprint_modules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `module_id` bigint unsigned NOT NULL,
  ...
  CONSTRAINT `module_blueprint_modules_blueprint_module_id_foreign` FOREIGN KEY (`blueprint_module_id`) REFERENCES `hrhub_blueprint_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `module_blueprint_modules_module_id_foreign` FOREIGN KEY (`module_id`) REFERENCES `hrhub_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_module_blueprint_modules`
--

LOCK TABLES `hrhub_module_blueprint_modules` WRITE;
/*!40000 ALTER TABLE `hrhub_module_blueprint_modules` DISABLE KEYS */;
INSERT INTO `hrhub_module_blueprint_modules` VALUES (1,9,5,'2026-07-18 11:29:42'),(2,10,6,'2026-07-18 11:29:42'),(3,11,7,'2026-07-18 11:29:42'),(4,8,9,'2026-07-18 11:29:42'),(8,8,4,'2026-07-18 04:33:48'),(9,14,10,'2026-07-20 01:09:37'),(10,16,11,'2026-07-22 02:43:38'),(11,17,12,'2026-07-29 03:31:43'),(12,17,13,'2026-07-29 03:32:08');
/*!40000 ALTER TABLE `hrhub_module_blueprint_modules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_modules`
--

DROP TABLE IF EXISTS `hrhub_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_modules` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `modules_blueprint_module_id_foreign` FOREIGN KEY (`blueprint_module_id`) REFERENCES `hrhub_blueprint_modules` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `modules_master_project_id_foreign` FOREIGN KEY (`master_project_id`) REFERENCES `hrhub_master_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_modules`
--

LOCK TABLES `hrhub_modules` WRITE;
/*!40000 ALTER TABLE `hrhub_modules` DISABLE KEYS */;
INSERT INTO `hrhub_modules` VALUES (7,7,'Posting Jobs','',1,NULL,'2026-07-13 01:19:36','2026-07-14 09:21:58',0),(8,13,'Kontrak Pegawai','',1,9,'2026-07-16 02:27:35','2026-07-18 03:39:27',0),(9,13,'Update Data Pegawai','',2,5,'2026-07-16 02:28:13','2026-07-17 03:33:41',0),(10,13,'Surat Peringatan','',3,6,'2026-07-16 02:28:21','2026-07-17 03:33:45',0),(11,13,'Memo Mutasi','',4,7,'2026-07-16 02:28:29','2026-07-17 03:33:31',0),(12,13,'Memo Karyawan Keluar','',5,NULL,'2026-07-16 02:28:39','2026-07-18 03:40:43',0),(13,8,'Penugasan','',1,NULL,'2026-07-19 23:15:04','2026-07-19 23:15:04',0),(14,14,'Sumbang Saran','Sumbang Saran',1,NULL,'2026-07-20 00:57:27','2026-07-20 00:57:27',0),(15,9,'Form Penilaian Karyawan Tetap','',1,NULL,'2026-07-22 02:37:17','2026-07-22 02:37:17',0),(16,15,'Jobdesc','',1,NULL,'2026-07-22 02:38:19','2026-07-22 02:38:19',0),(17,10,'Talent Review','Untuk melakukan talent review pegawai',1,NULL,'2026-07-29 03:31:22','2026-07-29 03:31:22',0),(18,12,'Personal Info','',1,NULL,'2026-08-20 01:52:11','2026-08-20 01:56:15',0),(19,12,'Leave','Digunakan untuk pengajuan Ijin meninggalkan pekerjaan',2,NULL,'2026-08-20 01:55:52','2026-08-20 01:55:52',0),(20,17,'Career Stages','',1,NULL,'2026-08-20 02:21:12','2026-08-20 02:21:12',0),(21,17,'Soft Competency','',2,NULL,'2026-08-20 02:21:23','2026-08-20 02:21:23',0),(22,9,'Form Permintaan Karyawan (FPK)','',2,NULL,'2026-08-20 06:15:23','2026-08-20 06:15:43',0),(23,9,'Input Kandidat','',3,NULL,'2026-08-20 06:16:09','2026-08-20 06:16:09',1),(24,18,'[Master Data] Jabatan','',1,NULL,'2026-08-20 06:17:42','2026-08-20 16:52:32',0),(25,18,'Recruitment','',2,NULL,'2026-08-20 06:17:54','2026-08-20 06:17:54',1),(26,18,'[Master Data] Departemen','',2,NULL,'2026-08-20 16:52:45','2026-08-20 16:52:45',0),(27,18,'[Recruitment] Kontrak','',3,NULL,'2026-08-20 16:52:57','2026-08-20 16:52:57',0);
/*!40000 ALTER TABLE `hrhub_modules` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_pages`
--

DROP TABLE IF EXISTS `hrhub_pages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_pages` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `module_id` bigint unsigned NOT NULL,
  ...
  CONSTRAINT `pages_blueprint_design_page_id_foreign` FOREIGN KEY (`blueprint_design_page_id`) REFERENCES `hrhub_blueprint_design_pages` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `pages_module_id_foreign` FOREIGN KEY (`module_id`) REFERENCES `hrhub_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_pages`
--

LOCK TABLES `hrhub_pages` WRITE;
/*!40000 ALTER TABLE `hrhub_pages` DISABLE KEYS */;
INSERT INTO `hrhub_pages` VALUES (9,7,NULL,'TMS (Admin)','ninebox/dashboard','testing',1,'2026-07-13 02:00:45','2026-07-13 02:00:45',0),(10,7,NULL,'Dashboard','ninebox/dashboard','',2,'2026-07-13 02:06:50','2026-07-13 02:06:50',0),(11,7,NULL,'Penilaian','ninebox/penilaian','',3,'2026-07-13 02:22:15','2026-07-13 02:22:15',0),(12,8,4,'Input Kontrak Pegawai','/kontrak','',1,'2026-07-16 03:46:25','2026-07-17 02:30:50',0),(13,13,NULL,'Create Penugasan','assignment/create','',1,'2026-07-19 23:44:35','2026-07-19 23:44:35',0),(14,13,NULL,'List Posted','assignment/posted','',2,'2026-07-19 23:44:57','2026-07-19 23:44:57',0),(15,13,NULL,'List Need Approval','assignment/need-approval','',3,'2026-07-19 23:45:27','2026-07-19 23:45:27',0),(16,13,NULL,'List Completed','assignment/approved','',4,'2026-07-19 23:45:54','2026-07-19 23:45:54',0),(17,13,NULL,'Display Penugasan','assignment/display','',5,'2026-07-19 23:46:07','2026-07-19 23:46:07',0),(18,13,NULL,'Approval','assignment/approval','',6,'2026-07-19 23:46:21','2026-07-19 23:46:21',0),(19,14,6,'create ss','/ss/create','',1,'2026-07-20 00:57:57','2026-07-20 01:10:00',0),(20,16,7,'Create (General)','/jobdesc/create','',1,'2026-07-22 02:38:38','2026-07-22 02:43:49',0),(21,17,10,'Penilaian (Manager)',NULL,'<p>Halaman yang digunakan untuk menampilkan list pegawai yang \"akan\" dinilai oleh manager, serta daftar pegawai bawahan (tidak langsung)</p>',0,'2026-07-29 04:05:30','2026-07-29 04:05:30',0),(22,17,11,'Penilaian (Vendor)',NULL,'<p>Halaman yang digunakan untuk menampilkan list pegawai yang akan di inputkan data hasil penilaian dari vendor</p>',1,'2026-07-29 04:05:30','2026-07-29 04:05:30',0),(23,17,12,'Create Assessment',NULL,'<p>Halaman yang digunakan untuk menginput penilaian manager</p>',2,'2026-07-29 04:05:30','2026-07-29 04:05:30',0),(24,17,13,'Create Assessment',NULL,'<p>Halaman yang digunakan untuk menginput penilaian vendor</p>',3,'2026-07-29 04:05:30','2026-07-29 04:05:30',0),(25,18,NULL,'Display','','Digunakan untuk menampilkan data (simple)',1,'2026-08-20 01:53:33','2026-08-20 01:53:33',0),(26,18,NULL,'Display Detail','','Digunakan untuk menampilakan display data pegawai secara detail',2,'2026-08-20 01:54:27','2026-08-20 01:54:27',0),(27,18,NULL,'Update','update-info/update','digunakan untuk melakukan pengajuan update personal information',3,'2026-08-20 01:55:12','2026-08-20 01:55:12',0),(28,16,NULL,'Records','ocha/','',2,'2026-08-20 01:57:46','2026-08-20 01:57:46',0),(29,16,NULL,'Assign Jabatan','jobcode/assigned','',3,'2026-08-20 02:05:16','2026-08-20 02:05:16',0),(30,16,NULL,'Import','jobcode/import','',4,'2026-08-20 02:05:32','2026-08-20 02:05:32',0),(31,16,NULL,'Monitoring Jabatan','jobcode/monitoring','',5,'2026-08-20 02:05:48','2026-08-20 02:05:48',0);
/*!40000 ALTER TABLE `hrhub_pages` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_project_attachments`
--

DROP TABLE IF EXISTS `hrhub_project_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_project_attachments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint unsigned NOT NULL,
  `uploaded_by` bigint unsigned NOT NULL,
  `filename` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  CONSTRAINT `project_attachments_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `hrhub_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `project_attachments_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_project_attachments`
--

LOCK TABLES `hrhub_project_attachments` WRITE;
/*!40000 ALTER TABLE `hrhub_project_attachments` DISABLE KEYS */;
INSERT INTO `hrhub_project_attachments` VALUES (3,9,6,'1-2.webp','1784049192_956f475c37c78208.webp','image/webp',74638,'2026-07-14 10:13:12',0),(4,10,6,'1-5.webp','1784110671_86c4c71d25fda558.webp','image/webp',43192,'2026-07-15 03:17:51',0);
/*!40000 ALTER TABLE `hrhub_project_attachments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_project_comments`
--

DROP TABLE IF EXISTS `hrhub_project_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_project_comments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `project_id` (`project_id`),
  CONSTRAINT `project_comments_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `hrhub_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_project_comments`
--

LOCK TABLES `hrhub_project_comments` WRITE;
/*!40000 ALTER TABLE `hrhub_project_comments` DISABLE KEYS */;
INSERT INTO `hrhub_project_comments` VALUES (1,9,6,'oke sip','2026-07-14 10:14:22',0),(2,10,6,'testing','2026-07-15 21:01:38',0);
/*!40000 ALTER TABLE `hrhub_project_comments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_project_user_types`
--

DROP TABLE IF EXISTS `hrhub_project_user_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_project_user_types` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `project_id` bigint unsigned NOT NULL,
  ...
  CONSTRAINT `fk_put_project` FOREIGN KEY (`project_id`) REFERENCES `hrhub_projects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_put_user_type` FOREIGN KEY (`user_type_id`) REFERENCES `hrhub_master_user_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_project_user_types`
--

LOCK TABLES `hrhub_project_user_types` WRITE;
/*!40000 ALTER TABLE `hrhub_project_user_types` DISABLE KEYS */;
INSERT INTO `hrhub_project_user_types` VALUES (1,12,2,'2026-07-30 18:19:52');
/*!40000 ALTER TABLE `hrhub_project_user_types` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_projects`
--

DROP TABLE IF EXISTS `hrhub_projects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_projects` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `status` tinyint NOT NULL DEFAULT '0',
  `approval_workflow` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  CONSTRAINT `projects_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_projects`
--

LOCK TABLES `hrhub_projects` WRITE;
/*!40000 ALTER TABLE `hrhub_projects` DISABLE KEYS */;
INSERT INTO `hrhub_projects` VALUES (9,'testing dan implementasi','alalalaskdskaldjasd','popolsakdjsladjsakldas','Performance',1,NULL,NULL,NULL,'2026-07-15',NULL,NULL,0,NULL,NULL,NULL,99,'{\"stages\": [\"it_manager\", \"dept_head\"]}',NULL,NULL,NULL,NULL,6,'2026-07-14 10:13:12','2026-07-14 10:14:00',1),(10,'tstinalskdjsaldjalskdj','lakjdlajdlsakdj','alksdslkadjsad','Performance',2,NULL,NULL,NULL,'2026-07-15',NULL,NULL,0,NULL,NULL,NULL,99,'{\"stages\": [\"it_manager\", \"dept_head\"]}',NULL,NULL,NULL,NULL,6,'2026-07-15 03:17:51','2026-07-15 03:17:51',1),(11,'Penambahan Fitur Upload File Excel pada Memo Mutasi','Digunakan untuk Admin OS','Admin OS mengupload file Execel, hasil upload akan di verifikasi oleh tim PW','New Feature',1,NULL,NULL,NULL,'2026-07-31',NULL,NULL,0,NULL,NULL,NULL,0,'{\"stages\": [\"it_manager\", \"dept_head\"]}',NULL,NULL,NULL,NULL,6,'2026-07-18 01:52:28','2026-07-18 01:52:28',0),(12,'perubahan struktur organisasi','testing dan implementasi saja','perubahan struktur organisasi dan impelmentasi','Other',2,NULL,8,NULL,'2026-08-03','Harian','lala lilili',1,'data karyawan','optimasi','xxxx',0,'{\"stages\": [\"it_manager\", \"dept_head\"]}',NULL,NULL,NULL,NULL,6,'2026-07-30 18:19:52','2026-07-30 18:19:52',0);
/*!40000 ALTER TABLE `hrhub_projects` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_role_permissions`
--

DROP TABLE IF EXISTS `hrhub_role_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_role_permissions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `role_permissions_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `hrhub_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_role_permissions`
--

LOCK TABLES `hrhub_role_permissions` WRITE;
/*!40000 ALTER TABLE `hrhub_role_permissions` DISABLE KEYS */;
INSERT INTO `hrhub_role_permissions` VALUES (1,5,'dashboard',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(2,5,'tickets',1,1,1,1,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(3,5,'improvements',1,1,1,1,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(4,5,'approvals',1,0,0,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(5,5,'master_projects',1,1,1,1,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(6,5,'users',1,1,1,1,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(7,5,'roles',1,1,1,1,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(8,4,'dashboard',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(9,4,'tickets',1,1,1,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(10,4,'improvements',1,1,1,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(11,4,'approvals',1,0,0,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(12,4,'master_projects',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(13,4,'users',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(14,4,'roles',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(15,3,'dashboard',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(16,3,'tickets',1,1,0,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(17,3,'improvements',1,1,0,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(18,3,'approvals',1,0,0,0,1,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(19,3,'master_projects',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(20,3,'users',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(21,3,'roles',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(22,1,'dashboard',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(23,1,'tickets',1,1,1,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(24,1,'improvements',1,1,1,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(25,1,'approvals',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(26,1,'master_projects',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(27,1,'users',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(28,1,'roles',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(29,2,'dashboard',1,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(30,2,'tickets',1,1,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(31,2,'improvements',1,1,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(32,2,'approvals',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(33,2,'master_projects',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(34,2,'users',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(35,2,'roles',0,0,0,0,0,'2026-07-11 16:15:19','2026-07-11 16:15:19',0),(36,5,'blueprints',1,1,1,1,1,'2026-07-14 10:41:15','2026-07-14 10:41:15',0),(37,4,'blueprints',1,0,0,0,1,'2026-07-14 10:41:15','2026-07-14 10:41:15',0),(38,3,'blueprints',1,0,0,0,1,'2026-07-14 10:41:15','2026-07-14 10:41:15',0),(39,1,'blueprints',1,1,1,0,0,'2026-07-14 10:41:15','2026-07-14 10:41:15',0),(40,2,'blueprints',1,0,0,0,0,'2026-07-14 10:41:15','2026-07-14 10:41:15',0),(42,5,'module_flows',1,1,1,1,0,'2026-08-18 07:22:30','2026-08-18 07:22:30',0),(43,1,'module_flows',1,1,1,1,0,'2026-08-18 07:22:30','2026-08-18 07:22:30',0),(44,4,'module_flows',1,1,1,0,0,'2026-08-18 07:22:30','2026-08-18 07:22:30',0),(45,3,'module_flows',1,0,0,0,0,'2026-08-18 07:22:30','2026-08-18 07:22:30',0),(46,2,'module_flows',1,0,0,0,0,'2026-08-18 07:22:30','2026-08-18 07:22:30',0);
/*!40000 ALTER TABLE `hrhub_role_permissions` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_roles`
--

DROP TABLE IF EXISTS `hrhub_roles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_roles` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `slug` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
--
-- Dumping data for table `hrhub_roles`
--

LOCK TABLES `hrhub_roles` WRITE;
/*!40000 ALTER TABLE `hrhub_roles` DISABLE KEYS */;
INSERT INTO `hrhub_roles` VALUES (1,'Developer','developer','Development team member',1,1,'2026-07-11 16:15:13','2026-07-11 16:15:13',0),(2,'Requester','requester','End user who submits tickets',1,1,'2026-07-11 16:15:13','2026-07-11 16:15:13',0),(3,'Dept Head','dept_head','Department head approver',1,1,'2026-07-11 16:15:13','2026-07-11 16:15:13',0),(4,'IT Manager','it_manager','IT department manager',1,1,'2026-07-11 16:15:13','2026-07-11 16:15:13',0),(5,'Admin','admin','Full system administrator',1,1,'2026-07-11 16:15:13','2026-07-11 16:15:13',0);
/*!40000 ALTER TABLE `hrhub_roles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_ticket_attachments`
--

DROP TABLE IF EXISTS `hrhub_ticket_attachments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_ticket_attachments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ticket_attachments_comment_id_foreign` FOREIGN KEY (`comment_id`) REFERENCES `hrhub_ticket_comments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ticket_attachments_ticket_id_foreign` FOREIGN KEY (`ticket_id`) REFERENCES `hrhub_tickets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `ticket_attachments_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_ticket_attachments`
--

LOCK TABLES `hrhub_ticket_attachments` WRITE;
/*!40000 ALTER TABLE `hrhub_ticket_attachments` DISABLE KEYS */;
/*!40000 ALTER TABLE `hrhub_ticket_attachments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_ticket_comments`
--

DROP TABLE IF EXISTS `hrhub_ticket_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_ticket_comments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `ticket_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  CONSTRAINT `ticket_comments_ticket_id_foreign` FOREIGN KEY (`ticket_id`) REFERENCES `hrhub_tickets` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_ticket_comments`
--

LOCK TABLES `hrhub_ticket_comments` WRITE;
/*!40000 ALTER TABLE `hrhub_ticket_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `hrhub_ticket_comments` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hrhub_tickets`
--

DROP TABLE IF EXISTS `hrhub_tickets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hrhub_tickets` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `tickets_assignee_id_foreign` FOREIGN KEY (`assignee_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL,
  CONSTRAINT `tickets_creator_id_foreign` FOREIGN KEY (`creator_id`) REFERENCES `hrhub_users` (`id`) ON DELETE CASCADE ON UPDATE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hrhub_tickets`
--

LOCK TABLES `hrhub_tickets` WRITE;
/*!40000 ALTER TABLE `hrhub_tickets` DISABLE KEYS */;
INSERT INTO `hrhub_tickets` VALUES (39,'TKT-20260730-1B72',NULL,'Update rumus Rumus','Perubahan dari menggunakan career stages menjadi agility',3,0,2,0,NULL,NULL,6,0,NULL,NULL,NULL,'2026-07-29 17:00:00','2026-07-29 20:10:12','2026-07-29 20:10:12',21,1),(40,'TKT-20260730-393B',NULL,'Perubahan pada halaman penilaian vendor','menyesuaikan rumus',3,0,1,0,NULL,NULL,6,0,NULL,NULL,NULL,'2026-07-29 17:00:00','2026-07-30 01:16:59','2026-07-30 01:16:59',22,1),(41,'TKT-20260731-604C',NULL,'update penilaian kalibrasi','testing dan implementasi',4,0,1,0,NULL,NULL,6,0,NULL,NULL,NULL,'2026-07-30 17:00:00','2026-07-31 02:55:47','2026-07-31 02:55:47',21,1),(42,'TKT-20260818-CF0C',NULL,'testing dan implementasi','laalllsadlksadlsad',2,0,1,2,NULL,6,6,0,NULL,NULL,NULL,NULL,'2026-08-18 02:27:42','2026-08-18 02:27:53',NULL,1);
/*!40000 ALTER TABLE `hrhub_tickets` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-08-21  8:26:17

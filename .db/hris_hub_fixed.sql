...
CREATE TABLE `audit_logs` (
  ...
  `entity_type` varchar(180) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `projects` (
  ...
  `frekuensi_penggunaan` varchar(20) DEFAULT NULL,
  `situasi_terkini` text,
  `ada_data_dianalisa` tinyint unsigned DEFAULT '0',
  `jenis_data_analisa` text,
  `tujuan_analisa` text,
  `dampak_manfaat` text,
  `status` tinyint unsigned NOT NULL DEFAULT '0',
  `approval_workflow` LONGTEXT,
  ...
  KEY `projects_approver_id_foreign` (`approver_id`),
  KEY `projects_dept_head_id_foreign` (`dept_head_id`),
  KEY `projects_it_manager_id_foreign` (`it_manager_id`),
